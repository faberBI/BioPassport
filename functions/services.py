...
# GPT
# ======================================================
def gpt_extract_from_pdf(text: str, client: OpenAI) -> dict:
    """Estrazione dati PDF tramite GPT-4-turbo"""
    prompt = f"""
...
def gpt_analyze_image(image_b64: str, client: OpenAI) -> dict:
    """Analisi immagine mobile tramite GPT-4-turbo"""
    prompt = """
...
def save_passport_to_file(passaporto: dict) -> str:
    """Salva passaporto in JSON su disco"""
